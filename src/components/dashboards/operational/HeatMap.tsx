  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3">
        {/* Leaflet Map */}
        <div className="lg:col-span-2 relative h-[300px] sm:h-[400px] lg:h-[480px]">
          <MapContainer
            center={center}
            zoom={11}
        ...
        <div
          className="p-4 overflow-auto border-t lg:border-t-0 lg:border-l"
      ...
      >
        <div className="flex items-center gap-3 sm:gap-4 flex-wrap text-[11px]" style={{ color: 'var(--text-muted)' }}>
